...
def test_consumption(kafka_consumer_mock: MagicMock, local_file_writer, clean_up_temp: Callable):
    ...
    # NOTE: 16 seconds is sufficient to generate 2 batches of messages to be written in 2 separate files
    ...
    # (4) Run consume loop
    # NOTE: test_consumer.py runs in a main thread.
    ...
    # (5) Let the consumer run for a while
    # NOTE: Simulate time for messages to be batched and flushed.
    ...
    # NOTE: Check that at least one file was created in the temporary directory
