...
class TestEvent(_message.Message):
    ...
    account_id: str
    user_role: UserRole
    def __init__(self, context: _Optional[_Union[_context_pb2.EventContext, _Mapping]] = ..., user_id: _Optional[str] = ..., account_id: _Optional[str] = ..., user_role: _Optional[_Union[UserRole, str]] = ...) -> None: ...
...
class YetAnotherTestEvent(_message.Message):
    ...
    def __init__(self, context: _Optional[_Union[_context_pb2.EventContext, _Mapping]] = ..., input_type: _Optional[_Union[InputType, str]] = ..., object_id: _Optional[str] = ..., object_type: _Optional[_Union[ObjectType, str]] = ...) -> None: ...
